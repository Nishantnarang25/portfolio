    ...
    <div className="w-full max-w-[700px] mx-auto px-6 py-4 bg-white shadow-sm rounded-xl mb-4 border border-white">
      ...
      {certificationsData.certifications.map((certification) => {
        return (
          ...
          >
            <div className="bg-white p-6 border border-[#E0E0E0] rounded-lg shadow-sm mb-6 transition-shadow duration-300 hover:shadow-lg">
              <img
              ...
              <div className="flex flex-col items-start">
                ...
                <button
                  type="button"
                  className="text-[#0A66C2] hover:text-[#0A3C7E] font-medium flex flex-row items-center text-sm"
                >
